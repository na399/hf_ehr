...
def calc_longest_repeated_substring(femr_db, pids: List[int], label_times: Optional[List[datetime.datetime]] = None, pids_idx = None) -> pd.DataFrame:
    """
    Calculate longest repeated substring.
...
def calc_n_gram_count(femr_db, pids, label_times: Optional[List[datetime.datetime]] = None, pids_idx = None) -> pd.DataFrame:
    """
...
def calc_inter_event_times(femr_db, pids: List[int], label_times: Optional[List[datetime.datetime]] = None, pids_idx = None) -> pd.DataFrame:
    """
    Calculate inter-event times.
    If label_times is provided, then calculate inter-event times only for events that occur before the label_times.
    """
